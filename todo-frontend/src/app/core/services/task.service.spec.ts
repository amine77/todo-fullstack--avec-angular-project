...
describe('TaskService', () => {
  ...
  describe('login()', () => {
    it('devrait envoyer un POST /api/auth/login et retourner un token', () => {
      ...
      const req = httpMock.expectOne('https://todo-backend-latest-zzys.onrender.com/api/auth/login');
  ...
  describe('getTasks()', () => {
    it('devrait retourner la liste des tâches via GET /api/tasks', () => {
      ...
      const req = httpMock.expectOne('https://todo-backend-latest-zzys.onrender.com/api/tasks');
  ...
  describe('toggleTask()', () => {
    it('devrait envoyer un PUT /api/tasks/{id}/toggle et retourner la tâche mise à jour', () => {
      ...
      const req = httpMock.expectOne('https://todo-backend-latest-zzys.onrender.com/api/tasks/1/toggle');
    ...
    it('devrait utiliser le bon id dans l\'URL pour toggle', () => {
      ...
      const req = httpMock.expectOne('https://todo-backend-latest-zzys.onrender.com/api/tasks/42/toggle');
  ...
  describe('deleteTask()', () => {
    it('devrait envoyer un DELETE /api/tasks/{id} et compléter sans corps', () => {
      ...
      const req = httpMock.expectOne('https://todo-backend-latest-zzys.onrender.com/api/tasks/1');
    ...
    it('devrait utiliser le bon id dans l\'URL pour delete', () => {
      ...
      const req = httpMock.expectOne('https://todo-backend-latest-zzys.onrender.com/api/tasks/99');
